...
export function DropdownItem({ item }: { item: NavItem }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full left-0 mt-1 w-44 rounded-xl border border-base-200 bg-background-50 shadow-lg py-1 z-50">
